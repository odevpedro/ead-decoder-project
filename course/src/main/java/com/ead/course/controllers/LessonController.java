...
public class LessonController {
    ...
    public ResponseEntity<Object> deleteLesson(@PathVariable(value = "moduleId")UUID courseId,
                                               @PathVariable(value = "lessonId")UUID moduleId){
        Optional<LessonModel> lessonModelOptional = lessonService.findLessonIntoModule(courseId, moduleId);
    ...
    public ResponseEntity<Object> updateLesson(@PathVariable(value = "moduleId") UUID moduleId,
        ...
        Optional<LessonModel> lessonModelOptional = lessonService.findLessonIntoModule(moduleId, moduleId);
        if (!lessonModelOptional.isPresent()) {
            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Lesson not found for this module");
        }
